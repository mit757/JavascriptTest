...
function filterUser() {
    ...
    var sortBy = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "acctData";
    ...
    if (sortDirection === "asc") acctData.sort(function (a, b) {
        return a[sortBy] > b[sortBy] ? 1 : -1;
    }); else acctData.sort(function (a, b) {
        return a[sortBy] > b[sortBy] ? -1 : 1;
    });
    return users;
}
